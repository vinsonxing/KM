package com.vinson.study.singleton;
 ...
 * http://localhost/servlet/joshuafox.singleton.ServletA
 *
...
public class ServletA extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request,
    ...
    out.println("<HTML><HEAD><TITLE>ServletA</TITLE></HEAD><BODY>");
  ...
  public String getHTMLMessage() {
    return "Hi, I'm <FONT COLOR='RED'>ServletA</FONT>" +
            ...
            "this will be constant for all instances of ServletA.";
  }
}
