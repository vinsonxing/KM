...
public class AttributeType  implements java.io.Serializable {
    ...
    /**
     * Gets the key value for this AttributeType.
     * 
     * @return key
     */
    ...
    /**
     * Sets the key value for this AttributeType.
     * 
     * @param key
     */
    ...
    public void setValue(int i, int _value) {
        this.value[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://api.baidu.com/sem/sms/v3", "AttributeType"));
