    ...
    smc.config(function ($stateProvider, $urlRouterProvider) {
      ...
      $stateProvider
        ...
        .state('chat', { // inject into the ui-view without name by default
          ...
          resolve: {testResolve: function() {return 'testResolveString'}},
          onEnter: ['$timeout','testResolve', function($timeout, testResolve){
            console.error('--->' +testResolve); // testResolve here is used as a string 'testResolveString', a return object from the resolve.
                                                // it can be from a promise. onEnter contrllor
